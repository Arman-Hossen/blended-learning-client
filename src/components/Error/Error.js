...
const Error = () => {
    return (
      <div >
        <div class="wrapper"><svg  viewBox="0 0 1920 1080">
  ...
  <g id="Layer_12 yellow-back-fig" data-name="Layer 12">
    ...
    <rect class="cls-1" x="580.91" y="671.98" width="413.38" height="8.39" rx="1.19" ry="1.19"/>
    ...
    <rect class="cls-1" x="392.21" y="720.64" width="149.8" height="6.39" rx="1.19" ry="1.19"/>
